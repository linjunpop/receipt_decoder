defmodule ReceiptDecoder do
  ...
  {:ok,
   %{application_version: "1241", bundle_id: "com.sumiapp.GridDiary",
     creation_date: ~N[2014-09-02 03:29:06], environment: "ProductionSandbox",
     in_apps: [%{cancellation_date: nil, expires_date: nil,
        original_purchase_date: ~N[2014-08-04 06:24:51],
      ...
      %{cancellation_date: nil, expires_date: nil,
